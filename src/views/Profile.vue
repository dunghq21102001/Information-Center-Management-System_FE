    ...
    <div class="w-full">
        <div class="w-full h-[150px] pl-5 mt-5 flex items-end">
            <div class="w-[150px] h-[150px] overflow-hidden rounded-full">
                <img src="https://cdn.pixabay.com/photo/2020/07/01/12/58/icon-5359553_640.png" alt="user img"
                    class="w-[150px] h-[150px] object-fill">
            </div>
            <div class="flex flex-col mb-1 ml-3">
                <span class="text-black text-[26px]">Dung HQ</span>
                <span class="text-gray-400 text-[16px]">Admin</span>
            </div>
        </div>
        ...
        <div class="w-full px-5 flex items-start mt-5">
            <div class="lg:w-[20%]">
                <ul class="w-full">
                    <li v-for="item in listTab" :class="`li-cus ${currentIndexTab == item.index ? 'active' : ''}`"
